...
You just got back from a business trip. You have a pile of receipts —
hotel invoices, flight confirmations, restaurant bills — all in different
...
**For a typical 3-day trip, this takes 30–60 minutes. Every single time.**
...
- 📄 Accepts PDF receipts — hotels, flights, meals, car rentals
...
👉 **[Open the Lab Guide →](BUILD_GUIDE_SIMPLE.md)**
...
- 💰 A **total trip budget** you can set before your trip
- 📂 **Per-category limits** for Hotel, Flight, Meal, and Car Rental
