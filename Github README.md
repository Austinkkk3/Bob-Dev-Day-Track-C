...
> **Build an AI-powered expense tracker in 90 minutes using IBM Bob and watsonx.ai.**
...
## Lab Overview (90 minutes)

```
Phase 1 — Setup         (~15 min)   Get credentials, create project folder
Phase 2 — Build with Bob (~55 min)   Prompt Bob to generate all 4 files
Phase 3 — Run & Test    (~20 min)   Install, launch, upload sample receipts
```
...
- 📄 [Sample Receipts](sample-receipts/) — Test PDFs to try the app
